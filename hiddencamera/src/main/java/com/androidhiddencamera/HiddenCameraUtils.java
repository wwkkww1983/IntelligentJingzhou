...
public final class HiddenCameraUtils {
    ...
    static File getCacheDir(Context context) {
        return Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES) == null
                ? context.getCacheDir() : Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES);
    }
    ...
    static boolean saveImageFromFile(@NonNull Bitmap bitmap,
        ...
        Log.i("HiddenCameraUtils", "saveImageFromFile fileToSave: "+fileToSave.getAbsolutePath());
        try {
