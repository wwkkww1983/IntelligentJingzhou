...
public final class CameraConfig {
    ...
    public class Builder {
        ...
        private File getDefaultStorageFile() {
            String cacheDir = HiddenCameraUtils.getCacheDir(mContext).getAbsolutePath();
            File dir =new File(cacheDir, "Capture");
            if(!dir.exists()){
                dir.mkdir();
            }
            CharSequence format = DateFormat.format("yyyyMMddHHmm", System.currentTimeMillis());
            return new File(dir, "IMG_CAPTURE"+format   //IMG_214515184113123.png
